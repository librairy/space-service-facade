...
public interface SpaceService {
  public static final org.apache.avro.Protocol PROTOCOL = org.apache.avro.Protocol.parse("{\"protocol\":\"SpaceService\",\"namespace\":\"org.librairy.service.space.facade.model\",\"types\":[{\"type\":\"record\",\"name\":\"Point\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"name\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"default\":\"unknown\"},{\"name\":\"type\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"default\":\"document\"},{\"name\":\"shape\",\"type\":{\"type\":\"array\",\"items\":\"double\"}}]},{\"type\":\"record\",\"name\":\"PointList\",\"fields\":[{\"name\":\"total\",\"type\":\"long\"},{\"name\":\"nextPage\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"points\",\"type\":{\"type\":\"array\",\"items\":\"Point\"}}]},{\"type\":\"record\",\"name\":\"Neighbour\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"name\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"default\":\"unknown\"},{\"name\":\"type\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"default\":\"document\"},{\"name\":\"score\",\"type\":\"double\"}]},{\"type\":\"record\",\"name\":\"Stats\",\"fields\":[{\"name\":\"total\",\"type\":\"long\",\"default\":0},{\"name\":\"min\",\"type\":\"long\",\"default\":0},{\"name\":\"max\",\"type\":\"long\",\"default\":0},{\"name\":\"mean\",\"type\":\"double\",\"default\":0.0},{\"name\":\"median\",\"type\":\"double\",\"default\":0.0},{\"name\":\"mode\",\"type\":\"double\",\"default\":0.0},{\"name\":\"var\",\"type\":\"double\",\"default\":0.0},{\"name\":\"dev\",\"type\":\"double\",\"default\":0.0}]},{\"type\":\"record\",\"name\":\"Summary\",\"fields\":[{\"name\":\"threshold\",\"type\":\"double\",\"default\":0.0},{\"name\":\"points\",\"type\":\"long\",\"default\":0},{\"name\":\"edges\",\"type\":\"long\",\"default\":0},{\"name\":\"types\",\"type\":[\"null\",{\"type\":\"map\",\"values\":\"long\",\"avro.java.string\":\"String\"}],\"default\":null},{\"name\":\"clusters\",\"type\":[\"null\",\"Stats\"],\"default\":null}]}],\"messages\":{\"addPoint\":{\"request\":[{\"name\":\"point\",\"type\":\"Point\"}],\"response\":\"boolean\"},\"getPoint\":{\"request\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}],\"response\":\"Point\"},\"removePoint\":{\"request\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}],\"response\":\"boolean\"},\"removeAll\":{\"request\":[],\"response\":\"boolean\"},\"listPoints\":{\"request\":[{\"name\":\"size\",\"type\":\"int\"},{\"name\":\"page\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}],\"response\":\"PointList\"},\"index\":{\"request\":[{\"name\":\"threshold\",\"type\":\"double\"}],\"response\":\"boolean\"},\"isIndexed\":{\"request\":[],\"response\":\"boolean\"},\"compare\":{\"request\":[{\"name\":\"shape1\",\"type\":{\"type\":\"array\",\"items\":\"double\"}},{\"name\":\"shape2\",\"type\":{\"type\":\"array\",\"items\":\"double\"}}],\"response\":\"double\"},\"getNeighbours\":{\"request\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"max\",\"type\":\"int\"},{\"name\":\"types\",\"type\":{\"type\":\"array\",\"items\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},\"default\":[]},{\"name\":\"force\",\"type\":\"boolean\",\"default\":false}],\"response\":{\"type\":\"array\",\"items\":\"Neighbour\"}},\"getSimilar\":{\"request\":[{\"name\":\"shape\",\"type\":{\"type\":\"array\",\"items\":\"double\"}},{\"name\":\"max\",\"type\":\"int\"},{\"name\":\"type\",\"type\":{\"type\":\"array\",\"items\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},\"default\":[]},{\"name\":\"force\",\"type\":\"boolean\",\"default\":false}],\"response\":{\"type\":\"array\",\"items\":\"Neighbour\"}},\"getSummary\":{\"request\":[],\"response\":\"Summary\"}}}");
  ...
  java.util.List<org.librairy.service.space.facade.model.Neighbour> getNeighbours(java.lang.String id, int max, java.util.List<java.lang.String> types, boolean force) throws org.apache.avro.AvroRemoteException;
  java.util.List<org.librairy.service.space.facade.model.Neighbour> getSimilar(java.util.List<java.lang.Double> shape, int max, java.util.List<java.lang.String> type, boolean force) throws org.apache.avro.AvroRemoteException;
  org.librairy.service.space.facade.model.Summary getSummary() throws org.apache.avro.AvroRemoteException;
  ...
  public interface Callback extends SpaceService {
    ...
    void getNeighbours(java.lang.String id, int max, java.util.List<java.lang.String> types, boolean force, org.apache.avro.ipc.Callback<java.util.List<org.librairy.service.space.facade.model.Neighbour>> callback) throws java.io.IOException;
    void getSimilar(java.util.List<java.lang.Double> shape, int max, java.util.List<java.lang.String> type, boolean force, org.apache.avro.ipc.Callback<java.util.List<org.librairy.service.space.facade.model.Neighbour>> callback) throws java.io.IOException;
    void getSummary(org.apache.avro.ipc.Callback<org.librairy.service.space.facade.model.Summary> callback) throws java.io.IOException;
  }
}